...
::: notes
There are many ways to ReproHack - You can attach them to an event, run them remotely, run an institutional one

but what we'd love to see more of is for research groups to start reproducing and reviewing their work before publication and start normalising the process reproducbility checks and developing the necessary skills
:::
