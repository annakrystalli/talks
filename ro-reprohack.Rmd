...
output:
  xaringan::moon_reader:
    css: [default, metropolis, assets/css/footer.css, metropolis-fonts, assets/css/ro-reprohack/styles.css]
    lib_dir: libs
    nature:
...
.image_profile[
<img src="assets/Radovan-Bast.jpeg" height=150px>
]

## width=150px### [Radovan Bast](https://bast.fr/) 
...
### [Scshort Reproducibility status report
...
- A lot### Problems with current model

 of work to get submissions

- Biased sample (self selected)
]
...
- **Medium term:** Make use of frameworks aggregating information on code and data availability
    ...
    + [Papers with code](https://paperswithcode.com/): platform Machine Learning papers, their code and evaluation tables.
