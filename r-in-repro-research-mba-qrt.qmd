...
::: column
![slides: [Karthik Ram: rstudio::conf 2019 talk](https://github.com/karthik/rstudio2019)](assets/reproducible-data-analysis-13.png)
:::
:::

<br>

**Ben Marwick, Carl Boettiger & Lincoln Mullen (2018)** [*Packaging Data Analytical Work Reproducibly Using R (and Friends)*](https://peerj.com/preprints/3192/)
...
![Boettiger, C. (2018) From noise to knowledge: how randomness generates novel phenomena and reveals information. <https://doi.org/10.1111/ele.13085>](assets/Boettiger-2018.png){heigth="250px" width="400"}
:::
...
## Why isn't sharing code _always_ enough?
