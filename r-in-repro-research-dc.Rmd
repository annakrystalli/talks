...
date: "<br> 2019/11/11 - <small> Imperial College, London </small>"
output:
...
<div class="my-footer"><span>Imperial College, London - Seminar    
...
### slides: **bit.ly/r-in-repro-research-dc**
...
.center[<img src="assets/travis.png" height=150px>]
]
...
<br>
<br>
![](assets/1728_TURI_Book sprint_17 continuous integration_040619.jpg)
...
* - docker build -t $REPO .
```
Create & run container using dockerfile, i.e. compile pkg and render Rmd to Word doc
